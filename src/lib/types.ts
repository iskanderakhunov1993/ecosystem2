 ...
 * «Тренировка» — третья вкладка: свой вопрос («что мне сегодня физически
 * можно и стоит делать»), отдельный от «что со мной сегодня».
 */
export type TabId = "today" | "cycle" | "activity";
