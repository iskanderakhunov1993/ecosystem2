  ...
  return (
    <div className="flex flex-col items-center pt-10 text-center">
      <div className="flex h-20 w-20 items-center justify-center rounded-[28px] border border-border bg-surface-2">
        <span className="font-display text-[30px] font-semibold text-accent-text">L</span>
      </div>
      <h1 className="mt-7 font-display text-[30px] font-semibold leading-tight text-text">Livi</h1>
